...
var jhipsterAllApp = angular.module('jhipsterAllApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'jhipsterAllAppUtils', 'pascalprecht.translate', 'truncate']);
