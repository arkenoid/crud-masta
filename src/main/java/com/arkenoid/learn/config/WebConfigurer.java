package com.arkenoid.learn.config;
...
import com.arkenoid.learn.web.filter.CachingHttpHeadersFilter;
import com.arkenoid.learn.web.filter.StaticResourcesProductionFilter;
import com.arkenoid.learn.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer {
    ...
    private void initAtmosphereServlet(ServletContext servletContext) {
        ...
        atmosphereServlet.setInitParameter("org.atmosphere.cpr.packages", "com.arkenoid.learn.web.websocket");
